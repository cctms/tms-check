                ...
                with c1:
                    ...
                    for nm, idx in t_l:
                        if ck(row.iloc[idx]) or (is_c and idx in [9, 10]):
                            m = next((s for s in r_s.keys() if nm in s), None)
                            if m:
                                with st.expander(nm):
                                    t = r_s[m].fillna(""); st.dataframe(t)
                                    t.insert(0, '시험', nm); all_d.append(t)
                                ...
                                for wn in w_l:
                                    if wn in c_s:
                                        with st.expander(wn):
                                            ...
                                            t.insert(0, '시험', wn); all_d.append(t)
                            elif nm in c_s:
                                with st.expander(nm):
                ...
                with c3:
                    ...
                    if ck(row.iloc[22]) and s_s:
                        ...
                        with st.expander("상대정확도 결과서"):
                            ...
                            t.insert(0, '시험', '상대정확도'); all_d.append(t)
